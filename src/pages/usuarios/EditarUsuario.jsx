...
const EditarUsuario = () => {
    ...
    const updateUser = async(event) => {
        ...
        try {
            const {data} = await axios.put(`https://65ec995e0ddee626c9b0a898.mockapi.io/api/v1/users/${params.id}`, user)
    ...
    const getUser = async (user_id) => {
        try {
            const {data} = await axios.get(`https://65ec995e0ddee626c9b0a898.mockapi.io/api/v1/users/${user_id}`)
            console.log(data);
                    ...
                    <form ref={formRef} onSubmit={updateUser}>
                        ...
                        <div className="row">
                            <div className="mb-3 col col-md-8">
                                ...
                                <input type="text" className="form-control" id="avatar" name="avatar" onInput={e => setUrlAvatar(e.target.value)}/>
                            </div>
                            <div className="col">
                                {urlAvatar && (
